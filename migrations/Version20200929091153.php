 ...
 */
final class Version20200929091153 extends AbstractMigration
{
    public function getDescription() : string
    {
        return 'ajout relation entre pins et users';
    }
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE pins ADD user_id INT DEFAULT NULL');
